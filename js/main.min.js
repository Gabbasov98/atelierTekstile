...
$(".header-catalog-item__show").click(function () {
    if(window.innerWidth>992){
        return
    }

    $(this).parents(".header-catalog-item").toggleClass("_open")
    $(this).siblings(".header-catalog-item__hidden").slideToggle()
})

$(".header-catalog-item").mouseover(function () {
    $(".header-catalog-item").removeClass("_hover")
    $(this).addClass("_hover")
})

$(".catalog-subitem").mouseover(function () {
    $(".catalog-subitem").removeClass("_hover")
    $(this).addClass("_hover")
})

$(".nav-item._catalog").mouseleave(function () {
    $(".catalog-subitem").removeClass("_hover")
    $(".header-catalog-item").removeClass("_hover")
})
...
$(".m-select").each(function(){
    let parent = $(this)
    let toggle = $(this).find('.m-select__show')
    let current = $(this).find('.m-select__current')
    ...
    $(parent).find(".select-option input").change(function () {
        select()
    })

    function select(){
        let val = $(parent).find(".select-option input:checked ~ .select-option__label").html()
        let parentBlock = $(parent).parents("._tabs-parent")
        let tabId = $(parent).find(".select-option input:checked").attr("data-tab")
